...
sealed class Operand {
  ...
  const factory Operand.none() = OperandNone;
  const factory Operand.reg(String registerName) = OperandReg;
  const factory Operand.mem0Reg(String registerName) = OperandMem0Reg;
  const factory Operand.mem0Imm16(int value) = OperandMem0Imm16;
  const factory Operand.mem1Reg(String registerName) = OperandMem1Reg;
  const factory Operand.mem1Imm16(int value) = OperandMem1Imm16;
  const factory Operand.imm8(int value) = OperandImm8;
  const factory Operand.dispPlus(int offset) = OperandDispPlus;
  const factory Operand.dispMinus(int offset) = OperandDispMinus;
  const factory Operand.mem0Cst8(int constant) = OperandMem0Cst8;
  const factory Operand.imm16(int value) = OperandImm16;
  ...
  String operandToString({
    ...
    OperandNone() => '',
    OperandReg(:final registerName) => registerName,
    OperandMem0Reg(:final registerName) => '($registerName)',
    OperandMem0Imm16(:final value) =>
      '(${OperandDump.op16(value, radix: radix, suffix: suffix).trim()})',
    OperandMem1Reg(:final registerName) => '#($registerName)',
    OperandMem1Imm16(:final value) =>
      '#(${OperandDump.op16(value, radix: radix, suffix: suffix).trim()})',
    OperandImm8(:final value) => OperandDump.op8(
      value,
      radix: radix,
      suffix: suffix,
    ),
    OperandDispPlus(:final offset) =>
      '+${OperandDump.op8(offset, radix: radix, suffix: suffix).trim()}',
    OperandDispMinus(:final offset) =>
      '-${OperandDump.op8(offset, radix: radix, suffix: suffix).trim()}',
    OperandMem0Cst8(:final constant) =>
      '(${OperandDump.op8(constant, radix: radix, suffix: suffix).trim()})',
    OperandImm16(:final value) => () {
...
class OperandNone extends Operand {
  ...
  @override
  bool operator ==(Object other) => other is OperandNone;

  @override
  int get hashCode => runtimeType.hashCode;
}

class OperandReg extends Operand {
  const OperandReg(this.registerName);
  final String registerName;

  @override
  bool operator ==(Object other) =>
      other is OperandReg && registerName == other.registerName;

  @override
  int get hashCode => registerName.hashCode;
}

class OperandMem0Reg extends Operand {
  const OperandMem0Reg(this.registerName);
  final String registerName;

  @override
  bool operator ==(Object other) =>
      other is OperandMem0Reg && registerName == other.registerName;

  @override
  int get hashCode => registerName.hashCode;
}

class OperandMem0Imm16 extends Operand {
  const OperandMem0Imm16(this.value);
  final int value;

  @override
  bool operator ==(Object other) =>
      other is OperandMem0Imm16 && value == other.value;

  @override
  int get hashCode => value.hashCode;
}

class OperandMem1Reg extends Operand {
  const OperandMem1Reg(this.registerName);
  final String registerName;

  @override
  bool operator ==(Object other) =>
      other is OperandMem1Reg && registerName == other.registerName;

  @override
  int get hashCode => registerName.hashCode;
}

class OperandMem1Imm16 extends Operand {
  const OperandMem1Imm16(this.value);
  final int value;

  @override
  bool operator ==(Object other) =>
      other is OperandMem1Imm16 && value == other.value;

  @override
  int get hashCode => value.hashCode;
}

class OperandImm8 extends Operand {
  const OperandImm8(this.value);
  final int value;

  @override
  bool operator ==(Object other) =>
      other is OperandImm8 && value == other.value;

  @override
  int get hashCode => value.hashCode;
}

class OperandDispPlus extends Operand {
  const OperandDispPlus(this.offset);
  final int offset;

  @override
  bool operator ==(Object other) =>
      other is OperandDispPlus && offset == other.offset;

  @override
  int get hashCode => offset.hashCode;
}

class OperandDispMinus extends Operand {
  const OperandDispMinus(this.offset);
  final int offset;

  @override
  bool operator ==(Object other) =>
      other is OperandDispMinus && offset == other.offset;

  @override
  int get hashCode => offset.hashCode;
}

class OperandMem0Cst8 extends Operand {
  const OperandMem0Cst8(this.constant);
  final int constant;

  @override
  bool operator ==(Object other) =>
      other is OperandMem0Cst8 && constant == other.constant;

  @override
  int get hashCode => constant.hashCode;
}

class OperandImm16 extends Operand {
  const OperandImm16(this.value);
  final int value;

  @override
  bool operator ==(Object other) =>
      other is OperandImm16 && value == other.value;
...
InstructionDescriptor _illegalInstruction(List<int> bytes) =>
    InstructionDescriptor(
      InstructionCategory.illegal,
      bytes,
      1,
      'ILL',
      const <Operand>[Operand.none(), Operand.none()],
...
final List<InstructionDescriptor> instructionTableFD = <InstructionDescriptor>[
  ...
  const InstructionDescriptor(
    ...
    2,
    'SBC',
    <Operand>[Operand.mem1Reg('X'), Operand.none()],
    CyclesCount(11, 0),
  ),
  ...
  const InstructionDescriptor(
    ...
    2,
    'SBC',
    <Operand>[Operand.mem1Reg('Y'), Operand.none()],
    CyclesCount(11, 0),
  ),
  ...
  const InstructionDescriptor(
    ...
    2,
    'LDX',
    <Operand>[Operand.reg('Y'), Operand.none()],
    CyclesCount(11, 0),
  ),
  const InstructionDescriptor(
    // AND #(Y)
  ...
  const InstructionDescriptor(
    ...
    2,
    'SBC',
    <Operand>[Operand.mem1Reg('U'), Operand.none()],
    CyclesCount(11, 0),
  ),
  ...
  const InstructionDescriptor(
    ...
    2,
    'LDX',
    <Operand>[Operand.reg('U'), Operand.none()],
    CyclesCount(11, 0),
  ),
  const InstructionDescriptor(
    // AND #(U)
  ...
  const InstructionDescriptor(
    ...
    2,
    'INC',
    <Operand>[Operand.reg('XH'), Operand.none()],
    CyclesCount(9, 0),
  ),
  ...
  const InstructionDescriptor(
    ...
    2,
    'LDX',
    <Operand>[Operand.reg('S'), Operand.none()],
    CyclesCount(11, 0),
  ),
  const InstructionDescriptor(
    // ANI #(X), i
    ...
    3,
    'ANI',
    <Operand>[Operand.mem1Reg('X'), Operand.imm8(0x00)],
    CyclesCount(17, 0),
  ),
  const InstructionDescriptor(
    // STX X
  ...
  const InstructionDescriptor(
    ...
    2,
    'INC',
    <Operand>[Operand.reg('YH'), Operand.none()],
    CyclesCount(9, 0),
  ),
  ...
  const InstructionDescriptor(
    ...
    2,
    'LDX',
    <Operand>[Operand.reg('P'), Operand.none()],
    CyclesCount(11, 0),
  ),
  const InstructionDescriptor(
    // ANI #(Y), i
    ...
    3,
    'ANI',
    <Operand>[Operand.mem1Reg('Y'), Operand.imm8(0x00)],
    CyclesCount(17, 0),
  ),
  const InstructionDescriptor(
    // STX Y
  ...
  const InstructionDescriptor(
    ...
    2,
    'INC',
    <Operand>[Operand.reg('UH'), Operand.none()],
    CyclesCount(9, 0),
  ),
  ...
  const InstructionDescriptor(
    ...
    3,
    'ANI',
    <Operand>[Operand.mem1Reg('U'), Operand.imm8(0x00)],
    CyclesCount(17, 0),
  ),
  const InstructionDescriptor(
    // STX U
  ...
  const InstructionDescriptor(
    ...
    2,
    'POP',
    <Operand>[Operand.reg('A'), Operand.none()],
    CyclesCount(12, 0),
  ),
  ...
  const InstructionDescriptor(
    ...
    4,
    'SBC',
    <Operand>[Operand.mem1Imm16(0x0000), Operand.none()],
    CyclesCount(17, 0),
  ),
  ...
  const InstructionDescriptor(
    ...
    5,
    'ANI',
    <Operand>[Operand.mem1Imm16(0x0000), Operand.imm8(0x00)],
    CyclesCount(23, 0),
  ),
  const InstructionDescriptor(
    // ADR U
...
final List<InstructionDescriptor> instructionTable = <InstructionDescriptor>[
  ...
  const InstructionDescriptor(
    ...
    1,
    'SBC',
    <Operand>[Operand.reg('XL'), Operand.none()],
    CyclesCount(6, 0),
  ),
  const InstructionDescriptor(
    // SBC (X)
    ...
    1,
    'SBC',
    <Operand>[Operand.mem0Reg('X'), Operand.none()],
    CyclesCount(7, 0),
  ),
  const InstructionDescriptor(
    // ADC XL
  ...
  const InstructionDescriptor(
    ...
    1,
    'SBC',
    <Operand>[Operand.reg('YL'), Operand.none()],
    CyclesCount(6, 0),
  ),
  const InstructionDescriptor(
    // SBC (Y)
    ...
    1,
    'SBC',
    <Operand>[Operand.mem0Reg('Y'), Operand.none()],
    CyclesCount(7, 0),
  ),
  const InstructionDescriptor(
    // ADC YL
  ...
  const InstructionDescriptor(
    ...
    1,
    'SBC',
    <Operand>[Operand.reg('UL'), Operand.none()],
    CyclesCount(6, 0),
  ),
  const InstructionDescriptor(
    // SBC (U)
    ...
    1,
    'SBC',
    <Operand>[Operand.mem0Reg('U'), Operand.none()],
    CyclesCount(7, 0),
  ),
  const InstructionDescriptor(
    // ADC UL
  ...
  const InstructionDescriptor(
    ...
    2,
    'LDI',
    <Operand>[Operand.reg('XH'), Operand.imm8(0x00)],
    CyclesCount(6, 0),
  ),
  const InstructionDescriptor(
    // ANI (X), i
    ...
    2,
    'ANI',
    <Operand>[Operand.mem0Reg('X'), Operand.imm8(0x00)],
    CyclesCount(13, 0),
  ),
  const InstructionDescriptor(
    // LDI XL, i
    ...
    2,
    'LDI',
    <Operand>[Operand.reg('XL'), Operand.imm8(0x00)],
    CyclesCount(6, 0),
  ),
  const InstructionDescriptor(
    // ORI (X), i
  ...
  const InstructionDescriptor(
    ...
    2,
    'LDI',
    <Operand>[Operand.reg('YH'), Operand.imm8(0x00)],
    CyclesCount(6, 0),
  ),
  const InstructionDescriptor(
    // ANI (Y), i
    ...
    2,
    'ANI',
    <Operand>[Operand.mem0Reg('Y'), Operand.imm8(0x00)],
    CyclesCount(13, 0),
  ),
  const InstructionDescriptor(
    // LDI YL, i
    ...
    2,
    'LDI',
    <Operand>[Operand.reg('YL'), Operand.imm8(0x00)],
    CyclesCount(6, 0),
  ),
  const InstructionDescriptor(
    // ORI (Y), i
  ...
  const InstructionDescriptor(
    ...
    2,
    'LDI',
    <Operand>[Operand.reg('UH'), Operand.imm8(0x00)],
    CyclesCount(6, 0),
  ),
  const InstructionDescriptor(
    // ANI (U), i
    ...
    2,
    'ANI',
    <Operand>[Operand.mem0Reg('U'), Operand.imm8(0x00)],
    CyclesCount(13, 0),
  ),
  const InstructionDescriptor(
    // LDI UL, i
    ...
    2,
    'LDI',
    <Operand>[Operand.reg('UL'), Operand.imm8(0x00)],
    CyclesCount(6, 0),
  ),
  const InstructionDescriptor(
    // ORI (U), i
  ...
  const InstructionDescriptor(
    ...
    2,
    'BCR',
    <Operand>[Operand.dispPlus(0x00), Operand.none()],
    CyclesCount(8, 2),
  ),
  const InstructionDescriptor(
    // ADC XH
  ...
  const InstructionDescriptor(
    ...
    2,
    'BCR',
    <Operand>[Operand.dispMinus(0x00), Operand.none()],
    CyclesCount(9, 2),
  ),
  const InstructionDescriptor(
    // ADC YH
  ...
  const InstructionDescriptor(
    ...
    3,
    'SBC',
    <Operand>[Operand.mem0Imm16(0x0000), Operand.none()],
    CyclesCount(13, 0),
  ),
  const InstructionDescriptor(
    // ADC UH
  ...
  const InstructionDescriptor(
    ...
    3,
    'LDI',
    <Operand>[Operand.reg('S'), Operand.imm16(0x0000)],
    CyclesCount(12, 0),
  ),
  const InstructionDescriptor(
    // ORA (ab)
  ...
  const InstructionDescriptor(
    ...
    2,
    'SBI',
    <Operand>[Operand.reg('A'), Operand.imm8(0x00)],
    CyclesCount(7, 0),
  ),
  ...
  const InstructionDescriptor(
    ...
    2,
    'EAI',
    <Operand>[Operand.imm8(0x00), Operand.none()],
    CyclesCount(7, 0),
  ),
  const InstructionDescriptor(
    // SJP i, j
  ...
  const InstructionDescriptor(
    ...
    1,
    'VEJ',
    <Operand>[Operand.mem0Cst8(0xC0), Operand.none()],
    CyclesCount(17, 0),
  ),
  const InstructionDescriptor(
    // VCR i
  ...
  const InstructionDescriptor(
    ...
    1,
    'VEJ',
    <Operand>[Operand.mem0Cst8(0xC2), Operand.none()],
    CyclesCount(17, 0),
  ),
  const InstructionDescriptor(
    // VCS i
  ...
  const InstructionDescriptor(
    ...
    1,
    'VEJ',
    <Operand>[Operand.mem0Cst8(0xC4), Operand.none()],
    CyclesCount(17, 0),
  ),
  const InstructionDescriptor(
    // VHR i
  ...
  const InstructionDescriptor(
    ...
    1,
    'VEJ',
    <Operand>[Operand.mem0Cst8(0xC6), Operand.none()],
    CyclesCount(17, 0),
  ),
  const InstructionDescriptor(
    // VHS i
  ...
  const InstructionDescriptor(
    ...
    1,
    'VEJ',
    <Operand>[Operand.mem0Cst8(0xC8), Operand.none()],
    CyclesCount(17, 0),
  ),
  const InstructionDescriptor(
    // VZR i
  ...
  const InstructionDescriptor(
    ...
    1,
    'VEJ',
    <Operand>[Operand.mem0Cst8(0xCA), Operand.none()],
    CyclesCount(17, 0),
  ),
  const InstructionDescriptor(
    // VZS i
  ...
  const InstructionDescriptor(
    ...
    1,
    'VEJ',
    <Operand>[Operand.mem0Cst8(0xCC), Operand.none()],
    CyclesCount(17, 0),
  ),
  const InstructionDescriptor(
    // VMJ i
  ...
  const InstructionDescriptor(
    ...
    1,
    'VEJ',
    <Operand>[Operand.mem0Cst8(0xCE), Operand.none()],
    CyclesCount(17, 0),
  ),
  const InstructionDescriptor(
    // VVS i
  ...
  const InstructionDescriptor(
    ...
    1,
    'VEJ',
    <Operand>[Operand.mem0Cst8(0xD0), Operand.none()],
    CyclesCount(17, 0),
  ),
  const InstructionDescriptor(
    // ROR
  ...
  const InstructionDescriptor(
    ...
    1,
    'VEJ',
    <Operand>[Operand.mem0Cst8(0xD2), Operand.none()],
    CyclesCount(17, 0),
  ),
  const InstructionDescriptor(
    // DRR (X)
  ...
  const InstructionDescriptor(
    ...
    1,
    'VEJ',
    <Operand>[Operand.mem0Cst8(0xD4), Operand.none()],
    CyclesCount(17, 0),
  ),
  const InstructionDescriptor(
    // SHR
  ...
  const InstructionDescriptor(
    ...
    1,
    'VEJ',
    <Operand>[Operand.mem0Cst8(0xD6), Operand.none()],
    CyclesCount(17, 0),
  ),
  const InstructionDescriptor(
    // DRL (X)
  ...
  const InstructionDescriptor(
    ...
    1,
    'VEJ',
    <Operand>[Operand.mem0Cst8(0xD8), Operand.none()],
    CyclesCount(17, 0),
  ),
  const InstructionDescriptor(
    // SHL
  ...
  const InstructionDescriptor(
    ...
    1,
    'VEJ',
    <Operand>[Operand.mem0Cst8(0xDA), Operand.none()],
    CyclesCount(17, 0),
  ),
  const InstructionDescriptor(
    // ROL
  ...
  const InstructionDescriptor(
    ...
    1,
    'VEJ',
    <Operand>[Operand.mem0Cst8(0xDC), Operand.none()],
    CyclesCount(17, 0),
  ),
  const InstructionDescriptor(
    // INC A
  ...
  const InstructionDescriptor(
    ...
    1,
    'VEJ',
    <Operand>[Operand.mem0Cst8(0xDE), Operand.none()],
    CyclesCount(17, 0),
  ),
  const InstructionDescriptor(
    // DEC A
  ...
  const InstructionDescriptor(
    ...
    1,
    'VEJ',
    <Operand>[Operand.mem0Cst8(0xE0), Operand.none()],
    CyclesCount(17, 0),
  ),
  const InstructionDescriptor(
    // SPU
  ...
  const InstructionDescriptor(
    ...
    1,
    'VEJ',
    <Operand>[Operand.mem0Cst8(0xE2), Operand.none()],
    CyclesCount(17, 0),
  ),
  const InstructionDescriptor(
    // RPU
  ...
  const InstructionDescriptor(
    ...
    1,
    'VEJ',
    <Operand>[Operand.mem0Cst8(0xE4), Operand.none()],
    CyclesCount(17, 0),
  ),
  ...
  const InstructionDescriptor(
    ...
    1,
    'VEJ',
    <Operand>[Operand.mem0Cst8(0xE6), Operand.none()],
    CyclesCount(17, 0),
  ),
  ...
  const InstructionDescriptor(
    ...
    1,
    'VEJ',
    <Operand>[Operand.mem0Cst8(0xE8), Operand.none()],
    CyclesCount(17, 0),
  ),
  const InstructionDescriptor(
    // ANI (ab), i
    ...
    4,
    'ANI',
    <Operand>[Operand.mem0Imm16(0x0000), Operand.imm8(0x00)],
    CyclesCount(19, 0),
  ),
  const InstructionDescriptor(
    // VEJ (EAH)
    ...
    1,
    'VEJ',
    <Operand>[Operand.mem0Cst8(0xEA), Operand.none()],
    CyclesCount(17, 0),
  ),
  const InstructionDescriptor(
    // ORI (ab), i
  ...
  const InstructionDescriptor(
    ...
    1,
    'VEJ',
    <Operand>[Operand.mem0Cst8(0xEC), Operand.none()],
    CyclesCount(17, 0),
  ),
  const InstructionDescriptor(
    // BII (ab), i
  ...
  const InstructionDescriptor(
    ...
    1,
    'VEJ',
    <Operand>[Operand.mem0Cst8(0xEE), Operand.none()],
    CyclesCount(17, 0),
  ),
  const InstructionDescriptor(
    // ADI (ab), i
  ...
  const InstructionDescriptor(
    ...
    1,
    'VEJ',
    <Operand>[Operand.mem0Cst8(0xF0), Operand.none()],
    CyclesCount(17, 0),
  ),
  const InstructionDescriptor(
    // AEX
  ...
  const InstructionDescriptor(
    ...
    1,
    'VEJ',
    <Operand>[Operand.mem0Cst8(0xF2), Operand.none()],
    CyclesCount(17, 0),
  ),
  ...
  const InstructionDescriptor(
    ...
    1,
    'VEJ',
    <Operand>[Operand.mem0Cst8(0xF4), Operand.none()],
    CyclesCount(17, 0),
  ),
  const InstructionDescriptor(
    // TIN
  ...
  const InstructionDescriptor(
    ...
    1,
    'VEJ',
    <Operand>[Operand.mem0Cst8(0xF6), Operand.none()],
    CyclesCount(17, 0),
  ),
  const InstructionDescriptor(
    // CIN
