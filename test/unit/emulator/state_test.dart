...
void main() {
  ...
  group('Register8', () {
    ...
    test('should be serialized/deserialized successfully', () {
      ...
      final Map<String, dynamic> state = reg1.saveState();
      final Register8 reg2 = Register8()..restoreState(state);
  ...
  group('Register16', () {
    ...
    test('should be serialized/deserialized successfully', () {
      ...
      final Map<String, dynamic> state = reg1.saveState();
      final Register16 reg2 = Register16()..restoreState(state);
      expect(reg1, equals(reg2));
    });
  ...
  group('LH5801State', () {
    ...
    test('toString() should return the expected value', () {
      ...
      expect(
        state.toString(),
        equals(
          'LH5801State(P: 0000, S: 0000, A: 00, X: 0000, Y: 0000, U: 0000, TM: LH5801Timer(value: 000, interrupt: false), IR0: false, IR1: false, IR2: false, HLT: false)',
        ),
      );
    });
  });
